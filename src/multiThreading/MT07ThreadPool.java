...
/* =============================================== THREAD POOL ====================================================
   ...
   Havuzun kapasitesi ölçüsünde thread'ler eş zamanlı hizmet görürler.
    ...
    Mesele buyuk sitelerde musteri gelmeden onceden belli sayıda thread acar, musteri gelince hazır threadları kullanırlar.
    Fazla musteri gelirse thradların sayısını ona gore artırır. Bekleyen gorevlerin sayısına gore
    Threadların sayısı oluşturulabilir.

    Özellikle ve sunucu ortamlarinda
