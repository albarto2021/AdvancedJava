...
/* ============================ WAIT, NOTIFY ==========================
   ...
   Mesela Banka hesabı aile üyeleri ortak kullansın. hesabın asıl sahibi butun parayı cekse (yani wait yapıyor)
        askıya alsa (suspend)  diğer aile bireyleri para cekmek istese para yok askıda olur.
        hesap sahibi o saniyelerde para yatırdığında (notify) askıdan inidrmiş olur.
