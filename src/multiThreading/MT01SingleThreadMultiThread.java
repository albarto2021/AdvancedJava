...
/* ============================================ THREAD, PROCESS=========================================================
    ...
    public boolean isDaemon(): Bir thread'in Deamon threat lup olmadıgını test eder. arkaplanda çalışırşar
                                garbage collector en iyi örnek.
    public void setDaemon(boolean b): Bir thread'i deoman thread olarak işaretler.
    public void interrupt(): Thread kesiintiye ugratır. :: interrupt: yarıda kesmek. mesela bir usb bellek takıldığında
            bilgisayar interrupt thread ı çalıştırır ve bütün işini bırakır onu çalıştırır ve çalıştırınca diğer
